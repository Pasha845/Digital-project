  ...
  <header class="header">
    <div class="header__container container flex">
      <router-link class="header__logo" to="/">
        <img loading="eager" src="/img/logo.svg" alt="Logo" width="70" height="44">
      </router-link>
      <nav class="header__cube">
        <ul class="header__menu flex">
          ...
          <li class="header__margin-link">
            <router-link class="header__link" to="/gallery">ГАЛЕРЕЯ</router-link>
          </li>
          <li class="header__margin-link">
            <router-link class="header__link" to="/projects">ПРОЕКТЫ</router-link>
          </li>
          <li class="header__margin-link">
            <router-link class="header__link" to="/certificates">СЕРТИФИКАТЫ</router-link>
          </li>
          <li class="header__margin-link">
            <router-link class="header__link" to="/contacts">КОНТАКТЫ</router-link>
          </li>
        </ul>
      </nav>
    ...
    <div class="footer__div">
      <div class="footer__container container">
        <router-link class="footer__logo" to="/">
          <img loading="lazy" src="/img/footer-logo.svg" alt="Logo" width="145" height="94">
        </router-link>
        <div>
          ...
          <ul>
            ...
            <li class="footer__margin-link">
              <router-link class="footer__link" to="/gallery">Галерея</router-link>
            </li>
            <li class="footer__margin-link">
              <router-link class="footer__link" to="/projects">Проекты</router-link>
            </li>
            <li class="footer__margin-link">
              <router-link class="footer__link" to="/certificates">Сертификаты</router-link>
            </li>
            <li class="footer__margin-link">
        ...
        <div>
          ...
          <ul>
            <li class="footer__margin-sublink">
            ...
            <li class="footer__margin-sublink">
              <a class="footer__link flex" href="tel:+77017776811">
        ...
        <div>
          ...
          <div class="footer__list">
            ...
            <a class="footer__icon linkedin" href="#" aria-label="LinkedIn">
              <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.512 18.013H1.48799C0.671986 18.013 0.0109863 17.434 0.0109863 16.72V1.28199C0.0109863 0.56899 0.671986 -0.0100098 1.48799 -0.0100098H18.512C19.327 -0.0100098 19.988 0.56899 19.988 1.28199V16.72C19.988 17.434 19.327 18.013 18.512 18.013ZM3.47299 15.044H6.41499V6.90699H3.47299V15.044ZM4.96399 2.98499C3.95699 2.98499 3.29999 3.59199 3.29999 4.39099C3.29999 5.17099 3.93799 5.79699 4.92499 5.79699H4.94399C5.96999 5.79699 6.60799 5.17099 6.60799 4.39099C6.58999 3.59199 5.96999 2.98499 4.96399 2.98499ZM17.023 10.379C17.023 7.87899 15.571 6.71599 13.636 6.71599C12.074 6.71599 11.376 7.50499 10.985 8.05999V6.90699H8.04299C8.08199 7.67099 8.04299 15.044 8.04299 15.044H10.985V10.5C10.985 10.258 11.004 10.014 11.082 9.84099C11.294 9.35499 11.779 8.85199 12.591 8.85199C13.656 8.85199 14.081 9.59799 14.081 10.692V15.044H17.023V10.379ZM10.965 8.08699C10.971 8.07799 10.979 8.06899 10.985 8.05999V8.08699H10.965Z" fill="currentColor" />
              </svg>
            </a>
            <a class="footer__icon pinterest" href="#" aria-label="Pinterest">
              <svg width="14" height="19" viewBox="0 0 14 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1_114)">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.42398 0C2.48898 0 0.000976562 3.522 0.000976562 6.46C0.000976562 8.238 0.676977 9.82 2.12798 10.41C2.36598 10.507 2.57898 10.413 2.64798 10.151C2.69598 9.97 2.80998 9.512 2.85998 9.321C2.92998 9.062 2.90298 8.971 2.71098 8.745C2.29198 8.254 2.02498 7.618 2.02498 6.717C2.02498 4.104 3.98898 1.765 7.13898 1.765C9.92798 1.765 11.46 3.462 11.46 5.727C11.46 8.709 10.135 11.225 8.16698 11.225C7.08098 11.225 6.26798 10.33 6.52798 9.233C6.84098 7.924 7.44498 6.51 7.44498 5.564C7.44498 4.718 6.98898 4.012 6.04398 4.012C4.93398 4.012 4.04198 5.156 4.04198 6.688C4.04198 7.665 4.37298 8.325 4.37298 8.325C4.37298 8.325 3.23598 13.119 3.03698 13.959C2.63998 15.631 2.97798 17.681 3.00598 17.889C3.02298 18.011 3.18098 18.04 3.25298 17.948C3.35498 17.814 4.67798 16.189 5.12798 14.564C5.25498 14.104 5.85798 11.722 5.85798 11.722C6.21898 12.407 7.27398 13.011 8.39498 13.011C11.734 13.011 13.999 9.98 13.999 5.924C13.999 2.857 11.39 0 7.42398 0Z" fill="currentColor" />
                </g>
                <defs>
...
<style lang="scss">
  ...
  .header {
    ...
    &__margin-link:first-child &__link {
    ...
    &__burger.is-opened span:nth-of-type(1) {
      display: none;
    }

    &__burger.is-opened span:nth-of-type(2) {
      top: 50%;
      transform: translate(-50%, 0%) rotate(45deg);  
    }

    &__burger.is-opened span:nth-of-type(3) {
      top: 50%;
      transform: translate(-50%, 0%) rotate(-45deg); 
    }
  ...
  .footer {
    ...
    &__margin-sublink:not(:last-child) {
      margin-bottom: 32px;
    }
